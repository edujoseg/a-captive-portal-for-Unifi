...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="assets/widgets/dialog/dialog-min.js"></script>
        <script type="text/javascript" src="assets/widgets/dialog/dialog-demo-min.js"></script>
                    ...
                    <div class="example-box-wrapper">
                        <div class="scrollable-content scrollable-xs scrollable-slim">
                            ...
                            <ol>
                                ...
                                <li>Interceptar, recopilar o almacenar datos sobre terceros sin su conocimiento o consentimiento. Escanear o probar la vulnerabilidad de equipos, sistemas o segmentos de red. Enviar mensajes no solicitados (spam), virus, o ataques internos o externos a la red universitaria.</li>
                                <li>Obtener acceso no autorizado a equipos, sistemas o programas tanto al interior de la red universitaria como fuera de ella. Tampoco podrá utilizar la red WI-FI para obtener, manipular y compartir cualquier archivo de tipo musical o filmográfico, sin tener los derechos de propiedad intelectual.</li>
...
<body class="main-header-fixed">
    <div id="page-wrapper">
                                ...
                                <div>
                                    <div class="thumbnail-box-wrapper mrg5A">
                                        <div class="thumbnail-box">
                                            ...
                                            <img src="assets/images/estetica-camillas-mini.jpg" alt="">
                                        </div>
        ...
        <div class="main-footer bg-gradient-4 clearfix">
            <div class="container clearfix">
                <div class="col-md-6 pad25R">
                    <div class="header">Getsemaní</div>
                    <p class="about-us">
                        Ubicado en el colonial barrio de Getsemaní del Centro Histórico de Cartagena de Indias, cuna del primer grito de independencia. Rodeado de magia, cultura y diversión.
                    </p>
                </div>
                <div class="col-md-4 pad25R">
                    <h3 class="header">Contácto</h3>
                    <ul class="footer-contact">
                        <li>
                            <i class="glyph-icon icon-home"></i>
                            Getsemaní, Cl. De la Media Luna # 10- 86
                        </li>
                        <li>
                            <i class="glyph-icon icon-phone"></i>
                            +57 (5) 6642208 | 6649430
                        </li>
                        <li>
                            <i class="glyph-icon icon-envelope-o"></i>
                            <a href="mailto:reservas@hostalcasabaluarte.com" title="">reservas@hostalcasabaluarte.com</a>
                        </li>
                    </ul>
                </div>
                <div class="col-md-2 pad25R">
                        <h3 class="header">Redes Sociales</h3>
                        <a href="https://m.facebook.com/hostalcasabaluartecartagena" target="_blank" class="btn btn-sm bg-facebook tooltip-button" data-placement="bottom" title="" data-original-title="Follow us on Facebook">
                                <i class="glyph-icon icon-facebook"></i>
                            </a>
                        <a href="https://m.flickr.com/#/photos/hostalcasabaluarte/" style="background-color: #128fdc;" target="_blank" class="btn btn-sm bg-facebook tooltip-button" data-placement="bottom" title="" data-original-title="Follow us on Google+">
                                <i class="glyph-icon icon-flickr"></i>
                            </a>
                        <a href="https://twitter.com/hostalcasabalua" target="_blank" class="btn btn-sm bg-twitter tooltip-button" data-placement="bottom" title="" data-original-title="Follow us on Twitter">
            ...
            <div class="footer-pane">
                <div class="container clearfix">
                    <div class="float-left" style="color: rgba(255, 255, 255, .8);">&copy; 2016 <a target="_blank" href="http://www.hostalcasabaluarte.com">Hotel Casa Baluarte</a>. Todos los derechos reservados.</div>
    ...
    <script src="assets/widgets/sticky/sticky.js" type="text/javascript"></script>
